...
void RFID(){
  ...
  uint8_t obj1[] = {0xB9, 0xC3, 0xD, 0xF4}; //the tag on the LED panel
  uint8_t obj2[] = {0xB9, 0x12, 0xD, 0xF4}; //the tag on the micrstickII
  uint8_t obj3[] = {0xC9, 0x82, 0xC, 0xF4};  //for the blue key tags
  uint8_t uidLength;

  Serial.println("Sensor ready!");
  detector = nfc.readPassiveTargetID(PN532_MIFARE_ISO14443A, &uid[0], &uidLength);
      //Comment again if not right^
      if(detector){
